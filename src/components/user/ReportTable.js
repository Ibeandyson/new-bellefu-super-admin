...
function ReportTable() {
  ...
  const resolveReview = (_id) => {
    Axios.get("https://bellefu.com/api/admin/report/resolve/" + _id, {
      headers: {
  ...
  const probeReview = (_id) => {
    Axios.get("https://bellefu.com/api/admin/report/probe/" + _id, {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
        Accept: "application/json",
  ...
  const deleteUser = (_id) => {
    Axios.get("https://bellefu.com/api/admin/report/delete/" + _id, {
      headers: {
        Authorization: `Bearer ${token}`,
        "Content-Type": "application/json",
        Accept: "application/json",
                      ...
                      <td>
                        <div className="btn-group" role="group">
                          ...
                          <Button
                            ...
                            variant="light"
                            onClick={() => {
                              const obj = reports.find((o, index) => index === key);
                              setad({
